...
const CategoryList = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      const endpoint = `${import.meta.env.VITE_ADMIN_URL}/property/category/list`;
  ...
  const confirmDelete = async () => {
    const endpoint = `${import.meta.env.VITE_ADMIN_URL}/property/category/delete/${selectedCategory._id}`;
    const authKey = localStorage.getItem('token');
  ...
  const updateCategory = async () => {
    const endpointDetails = `${import.meta.env.VITE_ADMIN_URL}/property/category/update/${selectedCategory._id}`;
    const endpointStatus = `${import.meta.env.VITE_ADMIN_URL}/property/category/status`;
    const authKey = localStorage.getItem('token');
