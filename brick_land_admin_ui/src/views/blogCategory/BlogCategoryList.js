...
const BlogCategoryList = () => {
  ...
  const confirmDelete = async () => {
    const endpoint = `${import.meta.env.VITE_ADMIN_URL}/blog/category/delete/${selectedCategory._id}`;
    const authKey = localStorage.getItem('token');
  ...
  const updateCategory = async () => {
    const endpointDetails = `${import.meta.env.VITE_ADMIN_URL}/blog/category/update/${selectedCategory._id}`;
    const endpointStatus = `${import.meta.env.VITE_ADMIN_URL}/blog/category/status`;
    const authKey = localStorage.getItem('token');
