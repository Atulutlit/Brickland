...
const { callbackList, callbackDetail, changeStatus, deletecallback } = require("../controller/callbackHandler");
...
callbackRoutes.put("/status",jwtAdminVerify,changeStatusJoiMiddleware,changeStatus);
